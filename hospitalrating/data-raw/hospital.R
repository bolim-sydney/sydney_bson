#' Dataset about 5344 different hospitals in the U.S.
#'
#'
#' @format A clean data frame with 5344 rows and 5 variables:
#' \describe{
...
#' }
#'
#' @source \url{https://data.medicare.gov/Hospital-Compare/Hospital-General-Information/xubh-q36u}
#' @export
"hospital"
